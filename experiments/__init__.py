...
def load_data__(x_name: str, y_names: list, names: list,
                root: str) -> np.ndarray:
...
def save_data__(data: list, x: np.ndarray, x_name: str,
                y_names: list, names: list, root: str) -> None:
...
def plot__(x: np.ndarray, ys: np.ndarray, names: list, colors: list,
           x_name: str, y_name: str,
           callback=lambda x: x, root: str="") -> None:
